...
class CoordinateTool {
	private static $xpi = 3.14159265358979324 * 3000.0 / 180.0; // 圆周率
	...
	public static function gcj_bd_batch(Array $address) {
		$batch = [];
		foreach ($address as $value) {
			$gcj_loc = new Coordinate($value[0], $value[1]);
			$batch[] = self::gcj_bd($gcj_loc);
		}
		return $batch;
	}
	/**
